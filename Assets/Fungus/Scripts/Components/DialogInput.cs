    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
         ...
         currentInputSystemUIInputModule=   EventSystem.current.GetComponent<InputSystemUIInputModule>();
            ...
            // }
   // 在访问按钮名称前添加空检查
    if (writer != null && currentInputSystemUIInputModule != null)
    {
         var submitAction = currentInputSystemUIInputModule.submit.action;
        var cancelAction = currentInputSystemUIInputModule.cancel.action;
          if (submitAction.WasPressedThisFrame() || 
           (cancelEnabled && cancelAction.IsPressed()))
        {
            SetNextLineFlag();
        }
        // if (Input.GetButtonDown(currentInputSystemUIInputModule.submit) ||
        //             (cancelEnabled && Input.GetButton(currentInputSystemUIInputModule.cancelButton)))
        //         {
        //             SetNextLineFlag();
        //         }
    }
