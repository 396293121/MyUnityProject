...
{
    BGMManager.Instance.PlaySFX(soundName);
}
...
private IEnumerator PerformAttack()
{
    ...
    // 播放攻击音效
    BGMManager.Instance?.PlaySFX("player_attack");
...
public void PerformHeavySlash()
{
    ...
    BGMManager.Instance?.PlaySFX("warrior_heavy_slash");
...
private void ExecuteHeavySlashAttack()
{
    ...
    foreach (Collider2D enemy in enemies)
    {
        ...
        if (enemyCharacter != null)
        {
            ...
            // 播放击中音效
            BGMManager.Instance?.PlaySFX("heavy_slash_hit");
        }
    }
}
```
...
public void PerformWhirlwind()
{
    ...
    BGMManager.Instance?.PlaySFX("warrior_whirlwind");
...
private void ExecuteWhirlwindAttack()
{
    ...
    foreach (Collider2D enemy in enemies)
    {
        ...
        if (enemyCharacter != null)
        {
            ...
            BGMManager.Instance?.PlaySFX("whirlwind_hit");
        }
    }
}
```
...
public void PerformBattleCry()
{
    ...
    BGMManager.Instance?.PlaySFX("warrior_battle_cry");
